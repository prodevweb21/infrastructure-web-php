...
<?php include_once "include/config.php";?>
  ...
  <?php
    ...
    $res = $mysqli->query("SELECT `id`, `titre`, `description_courte`, `date_nouvelle`, `actif`, `fk_categorie` FROM `nouvelles` WHERE actif AND fk_categorie=2 ORDER BY date_nouvelle DESC
    ");
